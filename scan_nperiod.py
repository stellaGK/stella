"""============================================================================================================================================================================= """
""" -------------------------------------------------------------------- A python script for scanning nperiod. ----------------------------------------------------------------- """
""" ============================================================================================================================================================================ """
...
for i in range(len(nperiod)):
    ...
    output_dir = f'NEO_stella_CBC_aky_0.3_beta_0.005_nperiod_scan_neoclassics'
    os.makedirs(output_dir, exist_ok=True)
    run_name = f'nperiod_{nperiod[i]}'
    ...
    mod_nml['z_grid']['nperiod'] = nperiod[i]
