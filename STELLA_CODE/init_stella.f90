...
!###############################################################################
   ...
   subroutine init_arrays_and_stella_modules(restarted, istep0)
      ...
      use quasineutrality_equation, only: init_quasineutrality_equation
      ...
      if (debug) write (6, *) 'stella::init_stella::init_quasineutrality_equation'
      call init_quasineutrality_equation
   ...
   subroutine init_electrostatic_and_magnetic_potential(restarted)
      ...
      use quasineutrality_equation, only: rescale_fields
      ...
      ! in initialise_distribution(). Use the quasineutrality condition to initialise 
      ! the electrostatic and electromagnetic fields (phi, apar, bpar).
      if (debug) write (6, *) 'stella::init_stella::advance_fields_using_quasineutrality_equation'
...
!###############################################################################
   ...
   subroutine finish_stella(istep, time_diagnose_stella, last_call)
      ...
      use quasineutrality_equation, only: finish_quasineutrality_equation
      ...
      if (debug) write (*, *) 'stella::finish_stella::finish_quasineutrality_equation'
      call finish_quasineutrality_equation
