...
! ================================================================================================================================================================================= !
!
! This module evolves the neoclassical drift terms. The dimensionless curvature drift term is given by:
!
! i * (v∥/2B₀) * exp(-v²) * ( b x κ ) ⋅( kx * ∇x + ky * ∇y ) * ( ∂H_1/∂v∥|_μ - 2 * v∥ * ( H_1 - eZ * ϕ₀¹ ) ) * <Χ_k>
!
...
! where: 
! 
! neocurvx = (v∥/2B₀) * exp(-v²) * ( ∂H_1/∂v∥|_μ - 2 * v∥ * ( H_1 - eZ * ϕ₀¹ ) ) * code_dt * ( b x κ ) ⋅∇x
! neocurvy = (v∥/2B₀) * exp(-v²) * ( ∂H_1/∂v∥|_μ - 2 * v∥ * ( H_1 - eZ * ϕ₀¹ ) ) * code_dt * ( b x κ ) ⋅∇y
!
! ================================================================================================================================================================================= !
...
! ================================================================================================================================================================================= !
    ...
    subroutine init_neo_curv_drift
        ...
        do ivmu = vmu_lo%llim_proc, vmu_lo%ulim_proc
            ...
            do iz = -nzgrid, nzgrid 
                neocurvx(:, iz, ivmu) = neocurvx(:, iz, ivmu) * ( dneo_h_dvpa(iz, ivmu, 1) - 2 * vpa(iv) &
            ...
            neocurvx(:, :, ivmu) = neocurvx(:, :, ivmu) * B_times_kappa_dot_gradx(:, :) * code_dt
            neocurvy(:, :, ivmu) = neocurvy(:, :, ivmu) * B_times_kappa_dot_grady(:, :) * code_dt
        end do
