...
! <TT
   ...
   interface scatter
      ...
      module procedure c_redist_45_inv
...
!
   ...
   subroutine c_redist_45(r, from_here, to_here)
   ...
   end subroutine c_redist_45

   subroutine c_redist_45_inv(r, from_here, to_here)
   ...
   end subroutine c_redist_45_inv
