...
contains
      ...
      if (proc0) then
         ...
         case (gridopt_box)
            call read_kxky_grids_box(nx, ny, ikx_max, naky_all, naky, nakx, nalpha, &
                 x0, y0, jtwist, jtwistfac, phase_shift_angle, centered_in_rho, &
                 randomize_phase_shift, periodic_variation, reality)
         end select
      end if
   ...
   contains
      ...
      ! The namelist parameters are available as public module variables, the
      ! calculated variables will be passed through <read_kxky_grids_box>.
      !subroutine read_kxky_grids_box_dummy(nx, ny, ikx_max, naky_all, naky, nakx, nalpha, &
      !  x0, y0, jtwist, jtwistfac, phase_shift_angle, centered_in_rho, &
      !  randomize_phase_shift, periodic_variation, reality)
      !   
      !   ! Namelist parameters 
      ...
      !   read_kxky_grids_range(ikx_max, naky_all, naky, nakx, reality)
      !   
