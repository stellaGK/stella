module coll_fokkerplanck
   ...
   public :: testpart, fieldpart, lmax, jmax, nvel_local, interspec, intraspec
   public :: iiknob, ieknob, eeknob, eiknob, eiediffknob, eideflknob, deflknob, eimassr_approx, advfield_coll, spitzer_problem
   public :: density_conservation, density_conservation_field, density_conservation_tp, exact_conservation, exact_conservation_tp
   public :: vpa_operator, mu_operator, cfac, cfac2, nuxfac, i1fac, i2fac, no_j1l1, no_j1l2, no_j0l2
