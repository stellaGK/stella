...
!###############################################################################
   ...
   subroutine write_potential_to_netcdf_file(istep, nout, timer, write_to_netcdf_file)
      ...
      if (proc0 .and. write_to_netcdf_file) then
         ...
         if (debug) write (*, *) 'diagnostics::diagnostics_potential::write_phi2_nc'
