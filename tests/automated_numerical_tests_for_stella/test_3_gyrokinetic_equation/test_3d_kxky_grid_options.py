...
#                                BOX NONLINEAR                                 #
#-------------------------------------------------------------------------------
def test_kxky_grid_box_nonlinear(tmp_path, error=False):

    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('kxky_grid_box_nonlinear.in', tmp_path)
...
#                                 BOX LINEAR                                   #
#-------------------------------------------------------------------------------
def test_kxky_grid_box_linear(tmp_path, error=False):

    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('kxky_grid_box_linear.in', tmp_path)
...
#                                RANGE LINEAR                                  #
#-------------------------------------------------------------------------------
def test_kxky_grid_range_linear(tmp_path, error=False):

    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('kxky_grid_range_linear.in', tmp_path)
...
#                                RANGE LINEAR                                  #
#-------------------------------------------------------------------------------
def test_kxky_grid_singlemode_linear(tmp_path, error=False):

    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('kxky_grid_singlemode_linear.in', tmp_path)
