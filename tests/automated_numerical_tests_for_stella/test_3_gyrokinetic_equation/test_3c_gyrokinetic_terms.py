...
def test_whether_nonlinear_term_evolves_correctly(tmp_path, error=False):
    ...
    run_data = run_local_stella_simulation('nonlinear_term.in', tmp_path)
...
def test_whether_parallel_streaming_implicit_evolves_correctly(tmp_path, error=False):
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('parallel_streaming_implicit.in' , tmp_path)
...
def test_whether_parallel_streaming_explicit_evolves_correctly(tmp_path, error=False):
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('parallel_streaming_explicit.in', tmp_path)
...
def test_whether_mirror_implicit_evolves_correctly(tmp_path, error=False):
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('mirror_implicit.in', tmp_path)
...
def test_whether_mirror_explicit_evolves_correctly(tmp_path, error=False): 
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('mirror_explicit.in', tmp_path) 
...
def test_whether_magnetic_drifts_explicit_evolves_correctly(tmp_path, error=False):
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('magnetic_drifts_explicit.in', tmp_path)
...
def test_whether_diamagnetic_drift_explicit_evolves_correctly(tmp_path, error=False):
    ...
    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('diamagnetic_drift_explicit.in', tmp_path)
...
#                               DRIFTS IMPLICIT                                #
#-------------------------------------------------------------------------------
def test_whether_drifts_implicit_evolves_correctly(tmp_path, error=False):

    # Run stella inside of <tmp_path>
    run_data = run_local_stella_simulation('drifts_implicit.in', tmp_path)
