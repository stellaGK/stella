...
# by one. Here we test the explicit magnetic drifts:
#       &physics_flags 
#         nonlinear = .true.
...
# Global variables  
input_filename = 'magnetic_drifts_explicit.in'  
...
#-------------------------------------------------------------------------------
#          Check whether the explicit magnetic drifts evolve correctly         #
#-------------------------------------------------------------------------------
def test_whether_magnetic_drifts_explicit_evolves_correctly(tmp_path):
