...
# Global variables  
input_filename = 'parallel_streaming_implicit.in'  
...
def test_whether_potential_data_in_netcdf_file_remains_constant(tmp_path):
    ...
    ################# SET-UP TESTS: TODO, REMOVE THIS #################
    if True:
        tmp_path = get_test_directory() / 'run_stella_temp'
        stella_local_run_directory = tmp_path 
    ################# SET-UP TESTS: TODO, REMOVE THIS #################
    ...
    ################# SET-UP TESTS: TODO, REMOVE THIS #################
    if True:
        test_directory = 'run_stella_broken'
        test_directory = 'run_stella_correct'
        expected_netcdf_file = stella_expected_run_directory / f'{test_directory}/{input_file_stem}.out.nc'  
    ################# SET-UP TESTS: TODO, REMOVE THIS #################
