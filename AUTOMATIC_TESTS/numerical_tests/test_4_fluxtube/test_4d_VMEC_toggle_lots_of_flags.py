...
#-------------------------------------------------------------------------------
def test_whether_a_mistake_was_introduced_in_an_extra_flag_1(tmp_path, stella_version, error=False):
...
#-------------------------------------------------------------------------------
def test_whether_a_mistake_was_introduced_in_an_extra_flag_2(tmp_path, stella_version, error=False):
