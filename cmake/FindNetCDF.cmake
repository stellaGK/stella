...
find_path (NETCDF_INCLUDES NAMES include/netcdf.h)
message ("${NETDF_INCLUDES}")
...
macro (NetCDF_check_interface lang header libs)
  if (NETCDF_${lang})
	message ( "searching for ${header}" )
    find_path (NETCDF_INCLUDES_${lang} NAMES ${header} )
	message ( "${NETCDF_INCLUDES_F90}" )
...
message ( ${NETCDF_LIBRARIES} ${NETCDF_INCLUDES} )
