"""============================================================================================================================================================================= """
""" ---------------------------------------------------------------------- A python script for scanning nzed. ------------------------------------------------------------------ """
""" ============================================================================================================================================================================ """
...
nzed = [4, 8, 12, 16, 20, 24, 28, 32, 36, 40]
...
for i in range(len(nzed)):
    # Output directory for all runs.
    output_dir = f'NEO_stella_CBC_aky_0.3_beta_0.005_nzed_scan_no_neoclassics'
    os.makedirs(output_dir, exist_ok=True)
    run_name = f'nzed_{nzed[i]}'
...
#SBATCH --job-name=neoclassical_stella                 # Job name
