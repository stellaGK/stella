...
`overwrite_gds2` | boolean | `false` | overwrite \\(  \lvert \nabla \alpha \rvert^2 (\operatorname{d}\!\psi / \operatorname{d}\!r)^2 \\).
`overwrite_gds21` | boolean | `false` | overwrite \\( \lvert \nabla q \cdot \nabla \alpha \rvert (\operatorname{d}\!\psi / \operatorname{d}\!r)^2 \\).
`overwrite_gds22` | boolean | `false` | overwrite \\( \lvert \nabla q \rvert^2 (\operatorname{d}\!\psi / \operatorname{d}\!r)^2 \\).
 `overwrite_gds23` | boolean | `false` | overwrite \\(  \nabla \theta \cdot [\nabla \alpha \times (\nabla r \times \nabla \alpha)] (\operatorname{d}\!\psi / \operatorname{d}\!r)^2 / B^2 \\).
 `overwrite_gds24` | boolean | `false` | overwrite \\( \nabla \theta \cdot [\nabla r \times (\nabla r \times \nabla \alpha)] (\operatorname{d}\!\psi / \operatorname{d}\!r)^2 (q/r) / B^2\\).
 `overwrite_gbdrift` | boolean | `false` | overwrite \\( 2 (\boldsymbol{b} \times \nabla B \cdot \nabla \alpha) (\operatorname{d}\!\psi / \operatorname{d}\!r) /B^2 \\).
  `overwrite_gbdrift0` | boolean | `false` | overwrite \\( 2 (\boldsymbol{b} \times \nabla B \cdot \nabla q) (\operatorname{d}\!\psi / \operatorname{d}\!r) /B^2  \\).
 `overwrite_cvdrift` | boolean | `false` | overwrite \\( 2(\operatorname{d}\!\psi / \operatorname{d}\!r)[\boldsymbol{b} \times (\boldsymbol{b \cdot \nabla b})]\cdot \nabla \alpha / B \\)
