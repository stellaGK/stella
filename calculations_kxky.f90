module calculations_kxky
  ...
  contains
    ...
    subroutine swap_kxky_complex(gin, gout)
        ...
        use arrays_kxky, only: naky, naky_all, ikx_max, nakx
    ...
    subroutine swap_kxky_ordered_real(gin, gout)
      ...
      use arrays_kxky, only: ikx_max, naky, nakx
        implicit none
    ...
    subroutine swap_kxky_back(gin, gout)
      use arrays_kxky, only: naky, nakx, naky_all, ikx_max
        implicit none
    ...
    subroutine communicate_ktgrids_multibox
        ...
        use mp, only: job, scope, &
             ...
             send, receive
        use arrays_kxky, only: phase_shift_angle
    ...
    !   use stella_transforms, only: transform_kx2x_xfirst, transform_x2kx_xfirst
        use arrays_kxky, only: rho_d_clamped, zonal_mode, g0x
