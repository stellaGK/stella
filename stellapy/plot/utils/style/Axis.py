...
class Axis:
    ...
    def __init__(self, ax, plot, overshoot_x=1.0, overshoot_y=1.1,
            logy=None, xbot=None, xtop=None, ybot=None, ytop=None, 
            xbot_pos=None, ybot_pos=None, xtop_neg=None, ytop_neg=None, percentage=None):
        ...
        # Overwrite the plot data
        if logy!=None: self.logy = logy
        if self.logy==True and self.ybot==0: self.ybot = None
        if self.logy==True and self.ybot_pos==0: self.ybot_pos = None 
        return
