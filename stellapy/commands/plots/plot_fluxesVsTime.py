#!/usr/bin/python3
''' Run plot_fluxesVsTime() as a bash command on the command prompt.'''
...
def main_program():
    if __name__ == "__main__":
        ...
        plot_fluxesVsTime_linear(**arguments)
