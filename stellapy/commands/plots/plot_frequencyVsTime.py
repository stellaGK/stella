#!/usr/bin/python3
''' Run plot_frequencyVsTime() as a bash command on the command prompt.'''
...
from stellapy.plot.frequencyAndGrowthrate import plot_frequencyVsTime

# If the program is run from the terminal, then collect the arguments and execute write_profiles()
def main_program():
    if __name__ == "__main__":
        function = "plot.frequencyAndGrowthrate.plot_frequencyVsTime"
        default_arguments = {\
        ...
        plot_frequencyVsTime(**arguments)
