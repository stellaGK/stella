#!/usr/bin/python3
''' Run reduce_sizeWout() as a bash command on the command prompt.'''
...
def get_arguments(function, default_arguments):
    ...
    or "old" in str(arguments['folder']):
