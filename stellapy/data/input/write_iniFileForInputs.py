...
def write_iniFile(input_parameters, input_file):
    ...
    default_parameters["parameters"]["teti"] = -1
    ...
    knobs += ["="*15+" OTHER "+"="*15] + ["time_advance_knobs", "kt_grids_knobs", "dist_fn_knobs", "physics_flags", "init_g_knobs", "layouts_knobs", "hyper"] # "neoclassical_input", "sfincs_input"
