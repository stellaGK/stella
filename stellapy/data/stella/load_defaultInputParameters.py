...
def load_defaultInputParameters():
    ...
    time_advance_knobs
        explicit_option; xdriftknob; ydriftknob; wstarknob; flip_flop
    ...
    input_parameters["kt_grids_box_parameters"] = {
            ...
            "kx max"            : -1.0      ,           # Derived input variable
            "ky max"            : -1.0      ,           # Derived input variable
            "Lx"                : -1.0      ,           # Derived input variable
            "Ly"                : -1.0      ,           # Derived input variable
