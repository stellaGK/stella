""" ============================================================================================================================================================================= """
""" --------------------- Plot mode frequency and growth rate against the parameter nzed (controls number of grid points in the field aligned coordinate, z). ------------------- """
""" ---------------------------------------------------- We should find that the complex frequency converges for increasing nzed. ----------------------------------------------- """ 
""" =============================================================================================================================================================================="""
...
nzed_vals = [4, 8, 12, 16, 20, 24, 28, 32, 36, 40]

final_omegas = []
final_gammas = []

for nzed in nzed_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_beta_0.005_nzed_scan_no_neoclassics/nzed_{nzed}"
...
for nzed in nzed_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_beta_0.005_nzed_scan_neoclassics/nzed_{nzed}"
    omega_f, gamma_f = get_final_omega_gamma(output_dir)
    if omega_f is not None:
...
ax1.plot(nzed_vals, final_omegas, 'o-', color='dodgerblue', label="conventional")
ax1.plot(nzed_vals, final_omegas_neo, 'o-', color='crimson', label="neoclassical")
...
ax2.plot(nzed_vals, final_gammas, 'o-', color='dodgerblue', label="conventional")
ax2.plot(nzed_vals, final_gammas_neo, 'o-', color='crimson', label="neoclassical")
...
output_filename = "/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_beta_0.005_nzed_scan_neoclassics/omega_gamma_vs_nzed.png"
