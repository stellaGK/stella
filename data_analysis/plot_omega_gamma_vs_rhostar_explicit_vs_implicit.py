...
""" ---------------------------------------------------- This is for comparing results from stellas explicit and implicit algorithm. -------------------------------------------- """ 
""" =============================================================================================================================================================================="""
...
for rhostar in rhostar_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_akx_0.1_electrostatic_rhostar_scan_neoclassics_adiabatic_e_explicit/rhostar_{rhostar}"
...
for rhostar in rhostar_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_akx_0.1_electrostatic_rhostar_scan_neoclassics_adiabatic_e_implicit/rhostar_{rhostar}"
    omega_f, gamma_f = get_final_omega_gamma(output_dir)
    if omega_f is not None:
...
ax1.plot(rhostar_vals, final_omegas, 'o-', color='dodgerblue', label="explicit")
ax1.plot(rhostar_vals, final_omegas_neo, 'o-', color='crimson', label=r"implicit")
ax1.set_xscale('log')
...
ax2.plot(rhostar_vals, final_gammas, 'o-', color='dodgerblue', label="explicit")
ax2.plot(rhostar_vals, final_gammas_neo, 'o-', color='crimson', label=r"implicit")
ax2.set_xscale('log')
...
fig.suptitle(r'CBC, $\beta = 0.0\%$, $k_y = 0.3$, $k_x = 0.1$, Adiabatic Electrons', fontsize=label_fontsize + 2)

output_filename = "/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_akx_0.1_electrostatic_rhostar_scan_neoclassics_adiabatic_e_explicit/omega_gamma_vs_rhostar_explicit_vs_implicit.png"
