...
for rhostar in rhostar_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_electrostatic_rhostar_scan_neoclassics_adiabatic_e_explicit/rhostar_{rhostar}"
...
for rhostar in rhostar_vals:
    output_dir = f"/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_electrostatic_rhostar_scan_neoclassics_adiabatic_e_implicit/rhostar_{rhostar}"
    omega_f, gamma_f = get_final_omega_gamma(output_dir)
    if omega_f is not None:
...
output_filename = "/users/rjs659/NEO_stella/NEO_stella_CBC_aky_0.3_electrostatic_rhostar_scan_neoclassics_adiabatic_e_explicit/omega_gamma_vs_rhostar.png"
